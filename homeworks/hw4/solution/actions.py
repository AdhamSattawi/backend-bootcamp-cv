...
def view_summary(my_budget: Budget)-> None:
    print("----------EXPENSES---------")
    all_incomes, all_expenses, total_income, total_expense, remaning_budget = my_budget.view_summary()
    print(f"""
    All Recorded Incomes: {all_incomes}
    All Recorded Expenses: {all_expenses}
